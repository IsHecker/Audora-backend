...
namespace Audora.Application.Common.Mapping;
...
public static class ContractMapping
{
    ...
    public static ListenerEntityReactionResponse ToResponse(this Reaction reaction)
    {
        return new ListenerEntityReactionResponse
        {
    ...
    // public static EpisodeSummaryResponse ToResponse(this Episode episode, EpisodeStat episodeStat)
    // {
